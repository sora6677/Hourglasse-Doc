...
傳入JSON：
  ...
  PeriodId(int)：期數
傳入範例：
  data={"RowCount":10,"GetPage":1,"PeriodId":2}
```
...
回傳參數：
  ...
  data(object)：
    TotalPage(int)：總頁數
    TotalCount(int)：總筆數
    UseList(object array)：
      UseId(int)：票券交易ID
      MemberId(string)：玩家的 memberID
      NickName(string)：玩家暱稱
      PeriodId(int)：期數
      UseBefore(int)：交易前
      UseQuantity(int)：交易數量
      UseAfter(int)：交易後
...
```
成功範例：
  {"status":200,"msg":"成功","data":{"TotalPage":1,"TotalRows":3,"UseList":[{"UseId":167291160774612,"MemberId":"LFtjoUck3CPDEWtkxfI77Csudfg2","NickName":"Daisy00001","PeriodId":2,"UseBefore":1498,"UseQuantity":10,"UseAfter":1488,"CreateTime":"2023-01-05 17:40:07","UseStatus":1},{"UseId":167291158770386,"MemberId":"LFtjoUck3CPDEWtkxfI77Csudfg2","NickName":"Daisy00001","PeriodId":2,"UseBefore":1499,"UseQuantity":1,"UseAfter":1498,"CreateTime":"2023-01-05 17:39:47","UseStatus":1},{"UseId":167291155074781,"MemberId":"LFtjoUck3CPDEWtkxfI77Csudfg2","NickName":"Daisy00001","PeriodId":2,"UseBefore":1000,"UseQuantity":1,"UseAfter":999,"CreateTime":"2023-01-05 17:39:10","UseStatus":1}]}}
失敗範例：
  參考共用錯誤代碼
```
